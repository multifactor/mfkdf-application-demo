          ...
          {this.state.loading ? <Loading /> : <>
            ...
            <form action="" onSubmit={this.submit}>
              <div className="mt-3">
                ...
                <input value="password" className="form-control" readOnly disabled type="password" />
              </div>
              <div className="mt-3">
                <label htmlFor="email" className="form-label">New Password</label>
                <input onChange={this.validate} ref={this.password} type="password" className={this.state.strength === 100 ? "form-control is-valid" : "form-control"} placeholder="Choose a password" />
              ...
              <div className="row">
                ...
                <div className="col-6">
                  <button disabled={!(this.state.strength === 100)} type="submit" className="mt-3 btn btn-success w-100 m-0">Update &nbsp;<i className="fa fa-check-circle"></i></button>
                </div>
              </div>
            </form>
          </>}
