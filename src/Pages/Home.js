        ...
        <div className="form text-center">
          ...
          <div className="card text-start">
            ...
            <p className="mt-3 mb-3">
              This application provides strong centralized password management
              functionality powered by multi-factor key derivation with advanced
              key derivation policies, factor persistence, self-service key
              recovery, MFKDF-based authentication, and end-to-end encryption.
            </p>
            <a
            ...
            <Link to="/register" className="btn btn-success m-0 mt-2">
              <i className="fa fa-user-plus" />
              &nbsp; Sign Up
            </Link>
            <Link to="/login" className="btn btn-light m-0 mt-2">
