...
class RecoverPassword extends React.Component {
  ...
  submit(e) {
    ...
    if (this.state.success) {
      if (this.state.emailCode && this.state.passwordValid && (this.state.rc || (this.state.sq1 && this.state.sq2 && this.state.sq3))) {
        const mfkdf = window.mfkdf;
        const password = mfkdf.derive.factors.password(this.password.current.value);
          ...
          {this.state.loading ? <Loading /> : <>
            ...
            {this.state.success ? <>
              <form action="" onSubmit={this.submit}>
                ...
                <button disabled={!(this.state.emailCode && this.state.passwordValid && (this.state.rc || (this.state.sq1 && this.state.sq2 && this.state.sq3)))} className="btn btn-success mt-3 mb-0 w-100" type="submit">Continue &nbsp;<i className="fa fa-arrow-right" /></button>
              </form>
            </> : <>
              <form action="" onSubmit={this.submit}>
                <div className="mt-3">
